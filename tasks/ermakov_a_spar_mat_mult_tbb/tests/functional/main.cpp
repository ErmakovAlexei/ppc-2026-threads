...
class ErmakovARunFuncTestSparMatMultTBB : public ppc::util::BaseRunFuncTests<InType, OutType, TestType> {
 public:
...
TEST_P(ErmakovARunFuncTestSparMatMultTBB, MatmulCRSTBB) {
...
const auto kTestTasksList =
    ppc::util::AddFuncTask<ErmakovASparMatMultTBB, InType>(kTestParam, PPC_SETTINGS_ermakov_a_spar_mat_mult_tbb);

const auto kGtestValues = ppc::util::ExpandToValues(kTestTasksList);

const auto kPerfTestName = ErmakovARunFuncTestSparMatMultTBB::PrintFuncTestName<ErmakovARunFuncTestSparMatMultTBB>;

INSTANTIATE_TEST_SUITE_P(SparseCRSMatMulTBBTests, ErmakovARunFuncTestSparMatMultTBB, kGtestValues, kPerfTestName);
